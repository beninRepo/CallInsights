...
export default class Departments extends React.Component {
    ...
    constructor() {
        ...
        this.state = {
            content: [
                { id: "1", name: "Others", count: "30" },
                { id: "2", name: "DEP", count: "22" },
                { id: "3", name: "ICC", count: "11" },
                { id: "2", name: "OM", count: "10" },
                { id: "3", name: "ABU", count: "09" },
